...
<h1 className='d-flex logincont justify-content-center'>
    LOG IN
</h1>
...
<span className='d-flex lower my-4'><a href=""><span style={{fontWeight:200}}>Not a member</span> <span className='mx-2' style={{fontSize:1.2+"rem"}}>JOIN</span></a></span>
</div>
