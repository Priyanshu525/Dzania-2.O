...
SIGN UP</span>
<div className='d-flex  justify-content-center' style={{marginBottom:10.3+"rem",marginTop:2+"rem"}}>
...
<button className='btn' style={{margin:"auto",marginTop:2+"rem"}}>Continue</button>
